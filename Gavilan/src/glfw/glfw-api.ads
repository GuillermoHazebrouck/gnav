...
private package Glfw.Api is
   ...
   pragma Import (Convention => C, Entity => Maximize_Window,
   ...
   --
   --===========================================================================
   procedure Set_Window_Attrib (Window : System.Address;
                                Attrib : Enums.Window_Info;
                                Value  : Enums.Glfw_Boolean);
   pragma Import (Convention => C, Entity => Set_Window_Attrib,
   ...
   --procedure Wait_Events_Timeout (Time : Interfaces.C.double);
   --pragma Import (Convention => C, Entity => Wait_Events_Timeout,
