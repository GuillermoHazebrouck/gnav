...
package body Maps.Terrain is
         ...
         while not End_Of_File (File_Id) loop
            ...
            --------------------------------------------------------------------
               ...
               for J in 1.. N loop
                  ...
                  Z_Min := Float'Min (Z, Z_Min);

                  Z_Max := Float'Max (Z, Z_Max);
   ...
   begin
      ...
      if N * M <= Terrain'Length then
         ...
         Float'Write (Stream, Z_Min);
         Float'Write (Stream, Z_Max);
   ...
   begin
      ...
      if Ada.Directories.Exists (Bin_File_Name) then
         ...
         Float'Read (Stream, Z_Min);
         Float'Read (Stream, Z_Max);
   ...
   begin
      ...
      if not Loaded or View.Height = 0.0 or View.Width = 0.0 or Z_Max < View.Zero then
