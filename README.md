...
> [!NOTE]
> There is also a [web version](https://github.com/GuillermoHazebrouck/gnav-web) of the project that is more advanced and can be installed on most mobile systems.
