...
package body Flight.Representation is
   ...
   begin
      ...
      for I in Cluster_Range loop
         ...
         if Clusters (I).Id > 0 then
            ...
            Gl.Shaders.Load_Color (Color_Gray_2);
   ...
   begin
      ...
      Gl.Shaders.Load_Color (Color_Black);

      Gl.Shaders.Load_Width (3.0);

      Gl.Draw_Arrays (GL_LINE_STRIP, 0, Size);

      Gl.Shaders.Load_Color (Color_White);
   ...
   begin
      ...
      then
         ...
         Gl.Shaders.Load_Color (Color_Gray_3);
         ...
         if not Flight_Plan.Waypoints (1).Is_Active then
            ...
            Gl.Shaders.Load_Color (Line_Magenta.Fore);

            Gl.Draw_Arrays (GL_LINES, 0, 2);

         end if;

         Gl.Shaders.Load_Color (Line_Grass.Fore);
