...
package Flight is
   ...
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   -- Start of GNAV time (reference)
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
   No_Time : constant Time := Time_Of (2020, 1, 1, 0.0); -- 01/01/2020 at 0:00 UTC
   
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
   --
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
   No_Age  : constant Duration := 60.0 * 60.0 * 24.0;
   ...
   --
   --===========================================================================
   function Get_Local_Time return Time;
   
   --===========================================================================
   -- Gets the UTC time
   --===========================================================================
   function Get_Utc_Time return Time;
...
private
   ...
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   Last_Time_Sync : Time := Clock - 3600.0;
   
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   -- The last data time (always from Clock, not local)
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   Clock_Offset : Duration := 0.0;
   
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   -- The local UTC offset (time zone) E.g.: (UTC+1 > 3600s)
   --+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   Utc_Offset   : Duration := 3600.0;
