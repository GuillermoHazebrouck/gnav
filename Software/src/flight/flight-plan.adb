...
package body Flight.Plan is
   ...
   begin
      ...
      if Ada.Directories.Exists (File_Name) then
         ...
         while not End_Of_File (File_Id) loop
            ...
            Line_Reader.Load (Get_Line (File_Id));
            ...
            begin
               ...
               if Key = "ACTIVE" then
                  ...
                  begin
                     if Index in Flight_Plan_Range then
   ...
   begin
      ...
      Put_Line (File_Id, "ACTIVE=" & Trim (Flight_Plan_Range'Image (Active_Flight_Plan)));
