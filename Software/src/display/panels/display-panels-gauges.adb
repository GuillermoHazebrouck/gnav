...
package body Display.Panels.Gauges is
   ...
   -- Fonts
   ---------------------------------
   Font_2 : Gl.Fonts.Font_Style_Record := (Width     => 0.015,
                                           Height    => 0.035,
                                           Space     => 0.008,
                                           Rendering => Gl.Fonts.Font_Glow,
                                           Thickness => Gl.Fonts.Font_Regular);
   ...
   -- Fonts
   ---------------------------------
   Font_4 : Gl.Fonts.Font_Style_Record := (Width     => 0.018,
                                           Height    => 0.070,
                                           Space     => 0.008,
                                           Rendering => Gl.Fonts.Font_Glow,
                                           Thickness => Gl.Fonts.Font_Regular);
   ...
   -- Fonts
   ---------------------------------
   Font_5 : Gl.Fonts.Font_Style_Record := (Width     => 0.010,
                                           Height    => 0.040,
                                           Space     => 0.008,
                                           Rendering => Gl.Fonts.Font_Glow,
                                           Thickness => Gl.Fonts.Font_Regular);
   ...
   -- Fonts
   ---------------------------------
   Font_6 : Gl.Fonts.Font_Style_Record := (Width     => 0.010,
                                           Height    => 0.040,
                                           Space     => 0.008,
                                           Rendering => Gl.Fonts.Font_Glow,
                                           Thickness => Gl.Fonts.Font_Regular);
   ...
   begin
      ...
      if Utc_Time then
         ...
         Clck := Flight.Get_Utc_Time;

      else

         Clck := Flight.Get_Local_Time;
      ...
      if Flight.Time_Synchronized then
         ...
         Clck_Color := Line_White;

      else

         Clck_Color := Line_Gray;

      end if;

      Gl.Fonts.Draw (Utility.Strings.Hour_Image (Clck),
                     0.945,
                     0.885,
                     Font_4,
                     Clck_Color,
      ...
      Gl.Fonts.Draw (Utility.Strings.Minute_Image (Clck),
                     0.990,
                     0.885,
                     Font_5,
                     Clck_Color,
      ...
      if Flight.Data.Is_Recent (Flight.Field_Speed) then
         ...
         Gl.Fonts.Draw (Utility.Strings.Float_Image (Convert (Flight.Data.Speed, Unit_Meter_Second, Velocity_Unit), 0),
                        0.935,
                        0.760,
                        Font_1,
                        Line_Cyan,
      ...
      Display.Compass.Draw (0.89, 0.320, 0.15, Width / Height, Font_1);
