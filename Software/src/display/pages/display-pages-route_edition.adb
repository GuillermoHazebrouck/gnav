...
package body Display.Pages.Route_Edition is
   ...
   begin
      ...
      if New_Focus /= Text_Focus then
         ...
         if Text_Focus /= null then
            ...
            Text_Focus.Set_Background_Color (Color_Magenta);
   ...
   begin
      ...
      Allocation.H := H;
      Allocation.W := W;
      Allocation.X := 1.0 - W - 0.01;
      Allocation.Y := 1.0 - H - 0.01;

      Ent_Route.Set_Label (Trim (Flight_Plan.Name));

      Ent_Route.Set_Allocation (Allocation);

      Ent_Route.Set_Background_Color (Color_Sky);
      ...
      Btn_Route_Previous.Set_Transparency (T);
      ...
      Btn_Route_Next.Set_Transparency (T);
      ...
      Btn_Route_Append.Set_Transparency (T);
      ...
      Btn_Route_Remove.Set_Transparency (T);
      ...
      Ent_Waypoint.Set_Background_Color (Color_Sky);
      ...
      Btn_Wypnt_Previous.Set_Transparency (T);
      ...
      Btn_Wypnt_Next.Set_Transparency (T);
      ...
      Btn_Wypnt_Prepend.Set_Transparency (T);
      ...
      Btn_Wypnt_Append.Set_Transparency (T);
      ...
      Btn_Wypnt_Remove.Set_Transparency (T);
      ...
      Btn_Wypnt_Down.Set_Transparency (T);
      ...
      Btn_Wypnt_Up.Set_Transparency (T);
      ...
      Btn_Wypnt_Right.Set_Transparency (T);
      ...
      Btn_Wypnt_Left.Set_Transparency (T);
      ...
      Btn_Wypnt_Step.Set_Transparency (T);
      ...
      Btn_View_South.Set_Transparency (T);
      ...
      Btn_View_North.Set_Transparency (T);
      ...
      Btn_View_East.Set_Transparency (T);
      ...
      Btn_View_West.Set_Transparency (T);
